...
E5.4g.2      strict float-to-double sum exposure           not started
...
exposure is now in progress. E5.4g.1 exposes the semantic writable borrow only;
the first public operation callable is E5.4g.2.
