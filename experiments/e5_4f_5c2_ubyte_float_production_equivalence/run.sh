...
echo '=== E5.4f.5c.2 UBYTE-TO-FLOAT PRODUCTION EQUIVALENCE ==='
...
OUT="$RUN/ubyte_float_production_equivalence.out"
ERR="$RUN/ubyte_float_production_equivalence.err"
EXPECTED="$RUN/ubyte_float_production_equivalence.expected"
...
echo
echo '=== RESULT ==='
echo 'ubyte-to-float production affine relation equivalence replay: PASS'
