...
define zeroext i1 @_D7imagery6raster8internal17scalar_conversion37scalarConvertUbyteToFloatContiguous1DFNaNbNiNfMS3mir7ndslice5slice__T9mir_sliceTPxhVmi1VEQBpQBoQBj14mir_slice_kindi2ZQBwMSQCwQCvQCq__TQCnTPfVmi1VQCfi2ZQDeZb(%"mir.ndslice.slice.Slice!(const(ubyte)*, 1LU, mir_slice_kind.contiguous).mir_slice" %source_arg, %"mir.ndslice.slice.Slice!(float*, 1LU, mir_slice_kind.contiguous).mir_slice" %target_arg) local_unnamed_addr #0 {
  ...
  %source_arg.fca.1.extract = extractvalue %"mir.ndslice.slice.Slice!(const(ubyte)*, 1LU, mir_slice_kind.contiguous).mir_slice" %source_arg, 1 ; [#uses = 12]
  ...
  %target_arg.fca.1.extract = extractvalue %"mir.ndslice.slice.Slice!(float*, 1LU, mir_slice_kind.contiguous).mir_slice" %target_arg, 1 ; [#uses = 12]
...
forbody.preheader:                                ; preds = %0
  %min.iters.check = icmp ult i64 %source_arg.fca.0.0.extract, 32 ; [#uses = 1]
  br i1 %min.iters.check, label %forbody.preheader13, label %vector.memcheck

forbody.preheader13:                              ; preds = %middle.block, %vector.memcheck, %forbody.preheader
  %__key28.08.ph = phi i64 [ 0, %vector.memcheck ], [ 0, %forbody.preheader ], [ %n.vec, %middle.block ] ; [#uses = 3, type = i64]
  %xtraiter = and i64 %source_arg.fca.0.0.extract, 7 ; [#uses = 2]
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0        ; [#uses = 1]
  br i1 %lcmp.mod.not, label %forbody.prol.loopexit, label %forbody.prol

forbody.prol:                                     ; preds = %forbody.preheader13, %forbody.prol
  %__key28.08.prol = phi i64 [ %6, %forbody.prol ], [ %__key28.08.ph, %forbody.preheader13 ] ; [#uses = 3, type = i64]
  %prol.iter = phi i64 [ %prol.iter.next, %forbody.prol ], [ 0, %forbody.preheader13 ] ; [#uses = 1, type = i64]
...
forbody.prol.loopexit:                            ; preds = %forbody.prol, %forbody.preheader13
  %__key28.08.unr = phi i64 [ %__key28.08.ph, %forbody.preheader13 ], [ %6, %forbody.prol ] ; [#uses = 1, type = i64]
  %7 = sub i64 %__key28.08.ph, %source_arg.fca.0.0.extract ; [#uses = 1]
  %8 = icmp ugt i64 %7, -8                        ; [#uses = 1]
...
vector.memcheck:                                  ; preds = %forbody.preheader
  ...
  br i1 %found.conflict, label %forbody.preheader13, label %vector.ph

vector.ph:                                        ; preds = %vector.memcheck
  %n.vec = and i64 %source_arg.fca.0.0.extract, -32 ; [#uses = 3]
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ] ; [#uses = 3, type = i64]
  %10 = getelementptr inbounds i8, ptr %source_arg.fca.1.extract, i64 %index ; [#uses = 4, type = ptr]
  %11 = getelementptr inbounds i8, ptr %10, i64 8 ; [#uses = 1, type = ptr]
  %12 = getelementptr inbounds i8, ptr %10, i64 16 ; [#uses = 1, type = ptr]
  %13 = getelementptr inbounds i8, ptr %10, i64 24 ; [#uses = 1, type = ptr]
  %wide.load = load <8 x i8>, ptr %10, align 1, !alias.scope !3 ; [#uses = 1]
  %wide.load10 = load <8 x i8>, ptr %11, align 1, !alias.scope !3 ; [#uses = 1]
  %wide.load11 = load <8 x i8>, ptr %12, align 1, !alias.scope !3 ; [#uses = 1]
  %wide.load12 = load <8 x i8>, ptr %13, align 1, !alias.scope !3 ; [#uses = 1]
  %14 = uitofp <8 x i8> %wide.load to <8 x float> ; [#uses = 1]
  %15 = uitofp <8 x i8> %wide.load10 to <8 x float> ; [#uses = 1]
  %16 = uitofp <8 x i8> %wide.load11 to <8 x float> ; [#uses = 1]
  %17 = uitofp <8 x i8> %wide.load12 to <8 x float> ; [#uses = 1]
  %18 = getelementptr inbounds float, ptr %target_arg.fca.1.extract, i64 %index ; [#uses = 4, type = ptr]
  %19 = getelementptr inbounds i8, ptr %18, i64 32 ; [#uses = 1, type = ptr]
  %20 = getelementptr inbounds i8, ptr %18, i64 64 ; [#uses = 1, type = ptr]
  %21 = getelementptr inbounds i8, ptr %18, i64 96 ; [#uses = 1, type = ptr]
  store <8 x float> %14, ptr %18, align 4, !alias.scope !6, !noalias !3
  store <8 x float> %15, ptr %19, align 4, !alias.scope !6, !noalias !3
  store <8 x float> %16, ptr %20, align 4, !alias.scope !6, !noalias !3
  store <8 x float> %17, ptr %21, align 4, !alias.scope !6, !noalias !3
  %index.next = add nuw i64 %index, 32            ; [#uses = 2]
  %22 = icmp eq i64 %index.next, %n.vec           ; [#uses = 1]
  br i1 %22, label %middle.block, label %vector.body, !llvm.loop !8

middle.block:                                     ; preds = %vector.body
  %cmp.n = icmp eq i64 %source_arg.fca.0.0.extract, %n.vec ; [#uses = 1]
  br i1 %cmp.n, label %common.ret, label %forbody.preheader13

common.ret:                                       ; preds = %forbody.prol.loopexit, %forbody, %middle.block, %0
  ret i1 %.not

forbody:                                          ; preds = %forbody.prol.loopexit, %forbody
  %__key28.08 = phi i64 [ %62, %forbody ], [ %__key28.08.unr, %forbody.prol.loopexit ] ; [#uses = 10, type = i64]
  %23 = getelementptr inbounds i8, ptr %source_arg.fca.1.extract, i64 %__key28.08 ; [#uses = 1, type = ptr]
  %24 = load i8, ptr %23, align 1                 ; [#uses = 1]
  %25 = uitofp i8 %24 to float                    ; [#uses = 1]
  %26 = getelementptr inbounds float, ptr %target_arg.fca.1.extract, i64 %__key28.08 ; [#uses = 1, type = ptr]
  store float %25, ptr %26, align 4
  %27 = add nuw i64 %__key28.08, 1                ; [#uses = 2]
  %28 = getelementptr inbounds i8, ptr %source_arg.fca.1.extract, i64 %27 ; [#uses = 1, type = ptr]
  %29 = load i8, ptr %28, align 1                 ; [#uses = 1]
  %30 = uitofp i8 %29 to float                    ; [#uses = 1]
  %31 = getelementptr inbounds float, ptr %target_arg.fca.1.extract, i64 %27 ; [#uses = 1, type = ptr]
  store float %30, ptr %31, align 4
  %32 = add nuw i64 %__key28.08, 2                ; [#uses = 2]
  %33 = getelementptr inbounds i8, ptr %source_arg.fca.1.extract, i64 %32 ; [#uses = 1, type = ptr]
  %34 = load i8, ptr %33, align 1                 ; [#uses = 1]
  %35 = uitofp i8 %34 to float                    ; [#uses = 1]
  %36 = getelementptr inbounds float, ptr %target_arg.fca.1.extract, i64 %32 ; [#uses = 1, type = ptr]
  store float %35, ptr %36, align 4
  %37 = add nuw i64 %__key28.08, 3                ; [#uses = 2]
  %38 = getelementptr inbounds i8, ptr %source_arg.fca.1.extract, i64 %37 ; [#uses = 1, type = ptr]
  %39 = load i8, ptr %38, align 1                 ; [#uses = 1]
  %40 = uitofp i8 %39 to float                    ; [#uses = 1]
  %41 = getelementptr inbounds float, ptr %target_arg.fca.1.extract, i64 %37 ; [#uses = 1, type = ptr]
  store float %40, ptr %41, align 4
  %42 = add nuw i64 %__key28.08, 4                ; [#uses = 2]
  %43 = getelementptr inbounds i8, ptr %source_arg.fca.1.extract, i64 %42 ; [#uses = 1, type = ptr]
  %44 = load i8, ptr %43, align 1                 ; [#uses = 1]
  %45 = uitofp i8 %44 to float                    ; [#uses = 1]
  %46 = getelementptr inbounds float, ptr %target_arg.fca.1.extract, i64 %42 ; [#uses = 1, type = ptr]
  store float %45, ptr %46, align 4
  %47 = add nuw i64 %__key28.08, 5                ; [#uses = 2]
  %48 = getelementptr inbounds i8, ptr %source_arg.fca.1.extract, i64 %47 ; [#uses = 1, type = ptr]
  %49 = load i8, ptr %48, align 1                 ; [#uses = 1]
  %50 = uitofp i8 %49 to float                    ; [#uses = 1]
  %51 = getelementptr inbounds float, ptr %target_arg.fca.1.extract, i64 %47 ; [#uses = 1, type = ptr]
  store float %50, ptr %51, align 4
  %52 = add nuw i64 %__key28.08, 6                ; [#uses = 2]
  %53 = getelementptr inbounds i8, ptr %source_arg.fca.1.extract, i64 %52 ; [#uses = 1, type = ptr]
  %54 = load i8, ptr %53, align 1                 ; [#uses = 1]
  %55 = uitofp i8 %54 to float                    ; [#uses = 1]
  %56 = getelementptr inbounds float, ptr %target_arg.fca.1.extract, i64 %52 ; [#uses = 1, type = ptr]
  store float %55, ptr %56, align 4
  %57 = add nuw i64 %__key28.08, 7                ; [#uses = 2]
  %58 = getelementptr inbounds i8, ptr %source_arg.fca.1.extract, i64 %57 ; [#uses = 1, type = ptr]
  %59 = load i8, ptr %58, align 1                 ; [#uses = 1]
  %60 = uitofp i8 %59 to float                    ; [#uses = 1]
  %61 = getelementptr inbounds float, ptr %target_arg.fca.1.extract, i64 %57 ; [#uses = 1, type = ptr]
  store float %60, ptr %61, align 4
  %62 = add nuw i64 %__key28.08, 8                ; [#uses = 2]
  %exitcond.not.7 = icmp eq i64 %62, %source_arg.fca.0.0.extract ; [#uses = 1]
  br i1 %exitcond.not.7, label %common.ret, label %forbody, !llvm.loop !11
}
